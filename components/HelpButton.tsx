...
const FEATURES: Feature[] = [
  {
    ...
    description:
      "Edit a rich-text document together, with every change synced and saved in real time.",
  },
  {
    icon: <UsersIcon />,
    title: "Live cursors and avatars",
    description:
      "See who else is in the document through live avatars and each other's cursors.",
  },
  {
    icon: <SparklesIcon />,
    title: "AI writing toolbar",
    description:
      "Select text and use the floating AI toolbar to generate, rewrite, or improve content.",
  },
  {
    icon: <CommentIcon />,
